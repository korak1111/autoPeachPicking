...
function capture_img(mode, file_name)
    imaqreset;
    imaqhwinfo;
...
function capture_rgb_img(file_name)
...
%     preview(vid1);
    ...
    rgbData=imresize(rgbData,[416 416]);
    imwrite(rgbData, file_name)
